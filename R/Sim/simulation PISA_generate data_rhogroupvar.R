...
registerDoSNOW(cl)
  ...
  for (th.offset in th.offset_r) {
      ...
      # print(th.offset)
      # print(b.time) 
    x<-simdata.rho(speed.offset=speed.offset,th.offset=th.offset,
               N=N,rho1=r1, rho2=r2, b.time=b.time, nitems=nitems)
    #x$gender= x$group
    ...
    out = c(N, speed.offset, b.time, th.offset, r1, r2, nitems, M[[1]], M[[2]],
...
names(result) = c("N", "speed","b.time", "ability","rho1","rho2","nitems","group1", "group2", 
...
result= write_csv(result,"Data/Sim data/result_v3_rho.csv")
